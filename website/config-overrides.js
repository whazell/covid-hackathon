...
module.exports = override(
  ...
  addLessLoader({
   ...
   "@secondary-color": "#d47fa6",
   "@success-color": "#52e97e",
   ...
   "@breadcrumb-last-item-color": "@text-color-secondary",
    ...
    "@slider-handle-shadow": "1px 1px 4px 0 rgba(0, 0, 0, 0.13)",
   ...
   "@slider-handle-color-focus": "#dedede",
    ...
    "@menu-item-active-bg": "#2699fb",
    "@menu-bg": "#2699fb",
    "@menu-item-height": "60px",
    "@layout-sider-background": "#2699fb",
    "@menu-highlight-color": "@primary-color",
    "@layout-trigger-background": "#2699fb",
    "@btn-primary-bg": "#2699fb"
    },
  }),
);
